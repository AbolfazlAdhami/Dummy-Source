class GitChecker {
  ...
  analyzeUnmergedBranches() {
    // Checks the branches that are not merged into the main branch yet
  }
}
...
class CodebaseAnalyzer {
  ...
  constructor({ repositoryPath, linterRules, dependencies }: { repositoryPath: string; linterRules: Array<string>; dependencies: Array<{ name: string; version: number }> }) {
